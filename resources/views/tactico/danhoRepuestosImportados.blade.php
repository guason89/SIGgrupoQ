...
<div class="panel with-nav-tabs panel-warning">
  <div class="panel-heading" style="text-align: center;">    	
			<b>Reporte De Daños De Repuestos Importados
	    	<br>Area Logistica En Bodegas
	    	<br>Grupo Q<b>
  </div>
  <div id="panel-collapse-info" class="collapse in">
    <form action="{{route('informe-daño-repuestos-importados')}}" method="POST" class="form form-vertical" role="form" id="almacenarRegistro" target="_blank">
