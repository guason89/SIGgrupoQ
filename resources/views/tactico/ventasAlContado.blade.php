...
<div class="panel with-nav-tabs panel-warning">
  <div class="panel-heading" style="text-align: center;">    	
			<b>Ventas Realizadas Al Contado; Por Cliente
	    	<br>Area Logistica En Bodegas
	    	<br>Grupo Q<b>
  </div>
  <div id="panel-collapse-info" class="collapse in">
    <form action="{{route('iforme-ventas-al-contado')}}" method="POST" class="form form-vertical" role="form" id="almacenarRegistro" target="_blank">
