...
<div class="panel with-nav-tabs panel-warning">
  <div class="panel-heading" style="text-align: center;">    	
			<b>Reporte De Ventas A Domicilio No Entregadas
	    	<br>Area Logistica En Bodegas
	    	<br>Grupo Q<b>
  </div>
  <div id="panel-collapse-info" class="collapse in">
    <form action="{{route('informe-ventas-no-entregadas')}}" method="POST" class="form form-vertical" role="form" id="almacenarRegistro" target="_blank">
