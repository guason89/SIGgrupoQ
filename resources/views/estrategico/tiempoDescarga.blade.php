...
<div class="panel with-nav-tabs panel-success">
  <div class="panel-heading" style="text-align: center;">    	
			<b>Tiempo De Descarga De Contenedores
	    	<br>Area Logistica En Bodegas
	    	<br>Grupo Q<b>
  </div>
  <div id="panel-collapse-info" class="collapse in">
    <form action="{{route('informe-tiempo-descarga')}}" method="POST" class="form form-vertical" role="form" id="almacenarRegistro" target="_blank">
